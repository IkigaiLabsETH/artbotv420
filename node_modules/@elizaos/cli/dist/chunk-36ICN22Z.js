...
var REGISTRY_REPO = "elizaos/registry";
...
var publish = new Command().name("publish").description("Publish a plugin or project to the registry").option("-r, --registry <registry>", "target registry", "elizaOS/registry").option("-n, --npm", "publish to npm instead of GitHub", false).option("-t, --test", "test publish process without making changes", false).option(
  "-p, --platform <platform>",
  "specify platform compatibility (node, browser, universal)",
  "universal"
).option("--dry-run", "generate registry files locally without publishing", false).option("--skip-registry", "skip publishing to the registry", false).action(async (opts) => {
  try {
